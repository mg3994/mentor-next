...
const sessionAnalyticsQuerySchema = z.object({
...
export async function GET(request: NextRequest) {
  try {
    ...
    const validatedParams = sessionAnalyticsQuerySchema.safeParse(queryParams)
    ...
    const sessionMetrics = await platformAnalyticsService.getSessionCompletionMetrics(
      parsedStartDate,
      parsedEndDate
    )
